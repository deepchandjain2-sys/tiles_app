...
if not st.session_state['auth']:
    ...
    with c2:
        ...
        with st.form("login_form"):
            ...
            if submit:
                if (u.upper() in ["DEEPCHAND JAIN", "ADMIN", "GOURAV"] and p in ["deep123", "pass123", "admin123", "GOURAV", "deep1965", "1234", "password"]) or (role_type == "Admin" and p in ["deep123", "admin123", "1234", "password"]):
